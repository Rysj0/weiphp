...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
    <div class="tab-content">
      <!-- 表单 -->
       <form id='form' action='http://localhost/weiphp/index.php?s=/w16/ShopCms/ShopCms/add/mdm/406.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-goodsName '>
			<label class='item-label'>商品名称</label>
			<div class='controls'><input type='text' class='text input-large' name='goodsName' value=''></div></div>
<div class='form-item cf toggle-goodsImage '>
			...
			<div class='controls'><div class='controls uploadrow2' data-max='1' title='点击修改图片' rel='goodsImage'>
					...
					<input type='hidden' name='goodsImage' id='cover_id_goodsImage' value=''/>
...
<div class='form-item cf toggle-goodsImgs '>
			...
			<div class='controls'><div class='mult_imgs'>
					<div class='upload-img-view' id='mutl_picture_goodsImgs'></div>
...
<div class='form-item cf toggle-goodsAddress '>
			...
			<div class='controls'><input type='text' class='text input-large' name='goodsAddress' value=''></div></div>
<div class='form-item cf toggle-goodsPrice '>
			<label class='item-label'>商品价格</label>
			<div class='controls'><input type='number' class='text' name='goodsPrice' value=''></div></div>
<div class='form-item cf toggle-goodsOldPrice '>
			<label class='item-label'>商品旧价格</label>
			<div class='controls'><input type='number' class='text' name='goodsOldPrice' value=''></div></div>
<div class='form-item cf toggle-iscollect '>
			<label class='item-label'>收藏</label>
			<div class='controls'><select name='iscollect'><option value='0' class='toggle-data' toggle-data='' selected >true</option><option value='1' class='toggle-data' toggle-data=''>false</option></select></div></div>
<div class='form-item cf toggle-goodsContent '>
			<label class='item-label'>商品描述</label>
			<div class='controls'><label class='textarea input-large'><textarea name='goodsContent'></textarea></label></div></div>
<div class='form-item cf toggle-brand '>
			<label class='item-label'>品牌</label>
			<div class='controls'><input type='text' class='text input-large' name='brand' value=''></div></div>
<div class='form-item cf toggle-yieldly '>
			<label class='item-label'>产地</label>
			<div class='controls'><input type='text' class='text input-large' name='yieldly' value=''></div></div>
<div class='form-item cf toggle-size '>
			<label class='item-label'>净含量</label>
			<div class='controls'><input type='text' class='text input-large' name='size' value=''></div></div>
<div class='form-item cf toggle-times '>
			<label class='item-label'>保质期</label>
			<div class='controls'><input type='text' class='text input-large' name='times' value=''></div></div>
<div class='form-item cf toggle-production '>
			<label class='item-label'>生产日期</label>
			<div class='controls'><input type='datetime' name='production' class='text date' value='' placeholder='请选择日期' /></div></div>
<div class='form-item cf toggle-savings '>
			<label class='item-label'>储蓄方法</label>
			<div class='controls'><input type='text' class='text input-large' name='savings' value=''></div></div>
<div class='form-item cf toggle-apply '>
			<label class='item-label'>适用人群</label>
			<div class='controls'><input type='text' class='text input-large' name='apply' value=''></div></div>
<div class='form-item cf toggle-eat '>
			<label class='item-label'>食用方法</label>
			<div class='controls'><input type='text' class='text input-large' name='eat' value=''></div></div>
<div class='form-item cf toggle-cozy '>
			<label class='item-label'>温馨提示</label>
			<div class='controls'><input type='text' class='text input-large' name='cozy' value=''></div></div>
<div class='form-item cf toggle-goodsDetails '>
			<label class='item-label'>商品详情</label>
			<div class='controls'><label class='textarea'><textarea name='goodsDetails' style='width:405px;height:100px;'></textarea><?php echo hook ( 'adminArticleEdit', [ 'name' => 'goodsDetails', 'value' => '' ] );?>  </label></div></div>
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/weiphp/Public/static/datetimepicker/css/datetimepicker.css?v=1530873733' rel='stylesheet' type='text/css'>
  <link href='/weiphp/Public/static/datetimepicker/css/dropdown.css?v=1530873733' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/weiphp/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/weiphp/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1530873733' charset='UTF-8'></script> 
  <script type='text/javascript'>
