<?php if (!defined('THINK_PATH')) exit(); switch($addons_config["editor_type"]): case "1": ?>
	...
	<?php case "2": ?>
		<input type="hidden" name="parse" value="0">
		<?php if(($addons_config["editor_wysiwyg"]) == "1"): ?><link rel="stylesheet" href="/weiphp/Public/static/kindeditor/default/default.css?v=<?php echo SITE_VERSION;?>" />
		...
		<?php else: ?>
			...
			<script type="text/javascript" charset="utf-8" src="/weiphp/Public/static/<?php echo ($driver_file); ?>/ueditor.config.js?v=<?php echo SITE_VERSION;?>"></script>
			<script type="text/javascript" charset="utf-8" src="/weiphp/Public/static/<?php echo ($driver_file); ?>/ueditor.all.js?v=<?php echo SITE_VERSION;?>"></script>
			<script type="text/javascript" charset="utf-8" src="/weiphp/Public/static/<?php echo ($driver_file); ?>/lang/zh-cn/zh-cn.js?v=<?php echo SITE_VERSION;?>"></script>
         
			<script type="text/javascript">
				$('textarea[name="<?php echo ($addons_data["name"]); ?>"]').attr('id', 'editor_id_<?php echo ($addons_data["name"]); ?>');
				window.UEDITOR_HOME_URL = "/weiphp/Public/static/<?php echo ($driver_file); ?>";
            ...
            <script type="text/javascript" charset="utf-8" src="/weiphp/Public/static/<?php echo ($driver_file); ?>/h5/main.js?v=<?php echo SITE_VERSION;?>"></script><?php endif; break;?>
	<?php case "3": ?>
