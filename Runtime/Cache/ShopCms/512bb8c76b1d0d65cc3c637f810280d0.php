...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      <div class="tab-content"> 
        <!-- 表单 -->
        <form id='form' action='http://localhost/weiphp/index.php?s=/w16/ShopCms/ShopCms/edit/mdm/406.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-goodsName '>
			<label class='item-label'>商品名称</label>
			<div class='controls'><input type='text' class='text input-large' name='goodsName' value='木村耀司登山旅行大学生户外情侣双肩背包外带小背包'></div></div>
<div class='form-item cf toggle-goodsImage '>
			<label class='item-label'>缩略图</label>
			<div class='controls'><div class='controls uploadrow2' data-max='1' title='点击修改图片' rel='goodsImage'>
					<input type='file' id='upload_picture_goodsImage'>
					<input type='hidden' name='goodsImage' id='cover_id_goodsImage' value='830'/>
					<div class='upload-img-box'><div class='upload-pre-item2'><img width='100' height='100' src='http://localhost/weiphp/Uploads/Picture/2018-07-06/5b3f42d4ade01.jpg'/></div><em class='edit_img_icon'>&nbsp;</em></div></div></div></div>
<div class='form-item cf toggle-goodsImgs '>
			<label class='item-label'>商品图片</label>
			<div class='controls'><div class='mult_imgs'>
					<div class='upload-img-view' id='mutl_picture_goodsImgs'><div class='upload-pre-item22'> <img width='100' height='100' src='http://localhost/weiphp/Uploads/Picture/2018-07-06/5b3f42dd0c396.jpg'/>
							<input type='hidden' name='goodsImgs[]' value='831'/><em>&nbsp;</em> </div><div class='upload-pre-item22'> <img width='100' height='100' src='http://localhost/weiphp/Uploads/Picture/2018-07-06/5b3f42d4ade01.jpg'/>
							<input type='hidden' name='goodsImgs[]' value='830'/><em>&nbsp;</em> </div><div class='upload-pre-item22'> <img width='100' height='100' src='http://localhost/weiphp/Uploads/Picture/2018-07-06/5b3f42e61eccf.jpg'/>
							<input type='hidden' name='goodsImgs[]' value='832'/><em>&nbsp;</em> </div></div>
					<div class='controls uploadrow2' data-max='9' title='点击上传图片' rel='goodsImgs'>
					<input type='file' id='upload_picture_goodsImgs'>
					</div>
					</div></div></div>
<div class='form-item cf toggle-goodsAddress '>
			<label class='item-label'>地址</label>
			<div class='controls'><input type='text' class='text input-large' name='goodsAddress' value='广州'></div></div>
<div class='form-item cf toggle-goodsPrice '>
			<label class='item-label'>商品价格</label>
			<div class='controls'><input type='number' class='text' name='goodsPrice' value='99'></div></div>
<div class='form-item cf toggle-goodsOldPrice '>
			<label class='item-label'>商品旧价格</label>
			<div class='controls'><input type='number' class='text' name='goodsOldPrice' value='169'></div></div>
<div class='form-item cf toggle-iscollect '>
			<label class='item-label'>收藏</label>
			<div class='controls'><select name='iscollect'><option value='0' class='toggle-data' toggle-data=''>true</option><option value='1' class='toggle-data' toggle-data='' selected >false</option></select></div></div>
<div class='form-item cf toggle-goodsContent '>
			<label class='item-label'>商品描述</label>
			<div class='controls'><label class='textarea input-large'><textarea name='goodsContent'>蜜蜂从植物的花中采取含水量约为75%的花蜜或分泌物，存入自己第二个胃中，在体内多种转化的作用下，经过15天左右反复酝酿各种维生素、矿物质和氨基酸丰富到一定的数值时，同时把花蜜中的多糖转变成人体可直接吸收的单糖葡萄糖、果糖，水分含量少于23%存贮到巢洞中，用蜂蜡密封。</textarea></label></div></div>
<div class='form-item cf toggle-brand '>
			<label class='item-label'>品牌</label>
			<div class='controls'><input type='text' class='text input-large' name='brand' value='蜂之堂'></div></div>
<div class='form-item cf toggle-yieldly '>
			<label class='item-label'>产地</label>
			<div class='controls'><input type='text' class='text input-large' name='yieldly' value='湖南长沙'></div></div>
<div class='form-item cf toggle-size '>
			<label class='item-label'>净含量</label>
			<div class='controls'><input type='text' class='text input-large' name='size' value='300g/罐'></div></div>
<div class='form-item cf toggle-times '>
			<label class='item-label'>保质期</label>
			<div class='controls'><input type='text' class='text input-large' name='times' value='12月'></div></div>
<div class='form-item cf toggle-production '>
			<label class='item-label'>生产日期</label>
			<div class='controls'><input type='datetime' name='production' class='text date' value='2018-07-12' placeholder='请选择日期' /></div></div>
<div class='form-item cf toggle-savings '>
			<label class='item-label'>储蓄方法</label>
			<div class='controls'><input type='text' class='text input-large' name='savings' value='低温避光存储'></div></div>
<div class='form-item cf toggle-apply '>
			<label class='item-label'>适用人群</label>
			<div class='controls'><input type='text' class='text input-large' name='apply' value='老少皆宜'></div></div>
<div class='form-item cf toggle-eat '>
			<label class='item-label'>食用方法</label>
			<div class='controls'><input type='text' class='text input-large' name='eat' value='直接食用或兑水'></div></div>
<div class='form-item cf toggle-cozy '>
			<label class='item-label'>温馨提示</label>
			<div class='controls'><input type='text' class='text input-large' name='cozy' value='请使用60度一下温水'></div></div>
<div class='form-item cf toggle-goodsDetails '>
			<label class='item-label'>商品详情</label>
			<div class='controls'><label class='textarea'><textarea name='goodsDetails' style='width:405px;height:100px;'><p><img src="http://img02.tooopen.com/images/20150928/tooopen_sy_143912755726.jpg" width="101" height="67"/></p></textarea><?php echo hook ( 'adminArticleEdit', [ 'name' => 'goodsDetails', 'value' => '<p><img src="http://img02.tooopen.com/images/20150928/tooopen_sy_143912755726.jpg" width="101" height="67"/></p>' ] );?>  </label></div></div>
<input type='hidden' name='id' value='1' />
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/weiphp/Public/static/datetimepicker/css/datetimepicker.css?v=1531044663' rel='stylesheet' type='text/css'>
  <link href='/weiphp/Public/static/datetimepicker/css/dropdown.css?v=1531044663' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/weiphp/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/weiphp/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1531044663' charset='UTF-8'></script> 
  <script type='text/javascript'>
