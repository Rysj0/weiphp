...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      <div class="table-bar">
        <div class="fl">
          <div class="tools"> <button class="btn" id="btnSubmit" type="button" >导出数据</button>
          </div>
        </div>
        <!-- 高级搜索 -->
        <div class="search-form fr cf">
          ...
          <div class="sleft">
            ...
            <a url="<?php echo addons_url('WeiUserCenter://WeiUserCenter/lists',$get_param);?>" id="search" href="javascript:;" class="sch-btn"><i class="btn-search"></i></a> </div>
        </div>
        <!-- 多维过滤 --> 
      </div>
      <!-- 数据列表 -->
      <div class="data-table">
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <!-- 列表 -->
            <tbody>
             <form class="muti_search cf"  name='form' id="form" action="<?php echo U('export');?>" method="post">
