...
<div id="main-container" class="container" style="position:relative">
  ...
  <div class="wrap" style="clear:both; margin:30px auto;">
    <section class="tab-content" id="contents"> 
      ...
      <div style="overflow:hidden; zoom:1;">
        <h3 style=" float:left;margin-bottom:15px;"><img style="vertical-align:middle; height:30px" src="/weiphp/Public/Home/images/weixin.png"/> 我的公众号</h3>
  ...
  <div class="wrap" style="clear:both; margin:30px auto;">
    <section class="tab-content" id="contents">
      <div style="overflow:hidden; zoom:1;">
        <h3 style=" float:left;margin-bottom:15px;"><img style="vertical-align:middle; height:25px" src="/weiphp/Public/Home/images/user_icon.png"/> 我的小程序</h3>
